...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-[#0f0f1b] to-[#1c1c2e] text-white">
            ...
            <div className="space-y-6">
              <motion.div className="flex items-center space-x-4" whileHover={{ x: 10 }}>
                ...
                <div>
                  ...
                  <p className="text-white font-medium">sharmarajesh42225@gmail.com</p>
                </div>
              </motion.div>
          ...
          >
            <div>
              ...
              <input
                ...
                id="name"
                required
                className="mt-1 block w-full rounded-md border-gray-600 bg-[#2a2a40] text-white placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            </div>
